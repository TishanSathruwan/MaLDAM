...
from src.utils import TryExcept, emojis
from src.utils.downloads import curl_download, gsutil_getsize
from src.utils.metrics import box_iou, fitness
...
def check_dataset(data, autodownload=True):
    ...
    if not path.is_absolute():
        path = (ROOT.parent / path).resolve()  # relative to project root, matching DATASETS_DIR
